...
class FandangoUpdater
{
    ...
    public function update($day)
    {
        ...
        $this->getMovies("Sacramento", "America/Los_Angeles", 38.5666, -121.4686, $day);
        $this->getMovies("Long Beach", "America/Los_Angeles", 33.8091, -118.1553, $day);
        $this->getMovies("Kansas City", "America/Chicago", 39.1252, -94.5511, $day);
        $this->getMovies("Mesa", "America/Denver", 33.4019, -111.7174, $day);
//        $this->getMovies("Atlanta", "Georgia", 33.7629, -84.4227, $day);
        $this->getMovies("Virginia Beach", "America/New_York", 36.7793, -76.024, $day);
        $this->getMovies("Omaha", "America/Chicago", 41.2647, -96.0419, $day);
